...
#### SERVER_NAME
defines the host name sent to CGI programs as a parameter. This is different from the "Server" attribute in the HTTP header which is hardcoded to "mrhttpd/2.4.4".
